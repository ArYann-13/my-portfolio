    ...
    const technologies = [
        {
            name: "MongoDB",
            svg: (
                <svg xmlns="http://www.w3.org/2000/svg" className="group-hover:text-gray-400 group relative text-1xl font-bold transition duration-300 " width="80" height="70" enableBackground="new 0 0 24 24" viewBox="0 0 24 24" id="mongodb">
        ...
        },
        {
            ...
            svg: (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="70" height="70" viewBox="0 0 80 80">
        ...
        },
        {
            ...
            svg: (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="90" height="80" viewBox="0 0 48 48">
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 dark:bg-opacity-80 z-50">
            <section className="flex flex-col md:flex-row items-center justify-between max-w-5xl mx-auto p-8 rounded-xl border border-gray-600 bg-gray-800 dark:bg-gray-900 shadow-lg relative">
                ...
                <div className="w-full md:w-1/2 text-white hidden md:block">
                    <h2 className="text-3xl font-bold mb-4">Let's Connect</h2>
                    <p className="text-lg text-gray-300">
                        I'm a passionate MERN Stack Developer. Let's collaborate and build amazing things together!
                    </p>
                    <div className="mt-6 flex space-x-6 text-white ">
                        {technologies.map((tech, index) => (
                            <div key={index} className="relative group">
                                <div className="transform transition-transform duration-300 group-hover:scale-110 mb-5 ">
                                    {tech.svg}
                                </div>
                                <span className="absolute opacity-0 group-hover:opacity-100 -bottom-1 left-1/2 transform -translate-x-1/2 translate-y-full bg-gray-900 text-white text-sm px-2 py-1
                ...
                <div className="w-full md:w-1/2 bg-[#1c1d25fb] p-6 rounded-lg">
                    <h3 className="text-xl text-white font-semibold mb-4">Contact Me</h3>
                    <form className="flex flex-col space-y-4" onSubmit={handleSubmit} >
                        <input
                            ...
                            className="p-3 rounded-md bg-gray-700 text-white border border-gray-600 focus:border-purple-400 focus:ring-2 focus:ring-purple-500 outline-none"
                        />
                        <input
                            type="email"
